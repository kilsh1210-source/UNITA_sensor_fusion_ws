...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'surround_view_node = camera_perception_pkg.surround_view_node:main',
            'multi_view_node = camera_perception_pkg.multi_view_node:main',
            'roi_picker_node = camera_perception_pkg.roi_picker_node:main',
